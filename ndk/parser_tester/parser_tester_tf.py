...
from ndk.tensorflow_interface import load_from_pb
...
config_file_name = 'parser_tester_config_tf.ini'
model_file = ''
input_file = ''
golden_file = ''
bitwidth = 8
...
def parser_tester_tf(model_file, input_file, golden_file, bitwidth, packing_net_for_chip, testing_float_parsing):
    layer_list0, param_dict0 = load_from_pb(model_file)
...
if __name__=='__main__':
    ...
    model_file = conf.get('input_file_path', 'model_file')
    ...
    parser_tester_tf(model_file, input_file, golden_file, bitwidth, packing_net_for_chip, testing_float_parsing)
